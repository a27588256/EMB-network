...
//     log.Info("emb miner verifyHeader Extra is ", "Extra", header.Extra, "length", len(header.Extra), "param max", params.MaximumExtraDataSize)
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	log.Info("emb miner reward is ", "rewarded", reward)
